...
from .legacy import (
    CalendarListView as LegacyCalendarListView,
    CalendarEventView as LegacyCalendarEventView,
)
from .calendar import CalendarListView, CalendarEventView
...
async def setup_legacy(hass: HomeAssistant, config: Config) -> bool:
    ...
    hass.http.register_view(LegacyCalendarListView(component))
    hass.http.register_view(LegacyCalendarEventView(component))
